...
#### Joining for EDA of Suicide Parameters
...
Save out the final data set

```{r}
#write.csv(suicidedata_analysis,'C:/magdalenecjw/SuicideSquad/EDA/data/suicide_analysis.csv', na = "", row.names = F)

#write.csv(suicidedata_eda,'C:/magdalenecjw/SuicideSquad/EDA/data/suicide_eda.csv', na = "", row.names = F)
```
